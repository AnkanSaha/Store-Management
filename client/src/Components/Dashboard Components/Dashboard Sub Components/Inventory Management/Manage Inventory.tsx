...
export default function Manage_Inventory({ ShopName }: props) {
  ...
  // Context API
  const { AlertMessage, AuthDetails, UpdateAlert, UpdateSidebarOption }: globe =
    React.useContext(GlobalContext); // Context API
                        ...
                        <>
                          ...
                          >
                            ...
                            >
                              <strong>
                                {" "}
                                {InventoryData.ProductName?.toUpperCase()}{" "}
                              </strong>
                            </th>
                            ...
                            <td className="px-6 py-4">
                              {InventoryData.ProductExpiryDate === ""
                                ? "N/A"
                                : InventoryData.ProductExpiryDate}
                            </td>
                            <td className="px-6 py-4">
                              {InventoryData.ProductManufacturingDate === ""
                                ? "N/A"
                                : InventoryData.ProductManufacturingDate}
                            </td>
                            <td className="px-6 py-4">
