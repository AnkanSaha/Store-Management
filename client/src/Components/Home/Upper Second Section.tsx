    ...
    <>
      <div className="my-7 mx-16">
        ...
        <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
          {AppName} is a free store management web app that helps you manage
          your store and keep track of your inventory. It is a free web app that
          is easy to use and is available on all devices.
        </p>
      </div>
      <br />
      <br />
