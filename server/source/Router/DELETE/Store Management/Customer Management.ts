...
// All Router Below
CustomerManagementRouter.delete(
    '/delete/:User_idForParams/:OwnerEmailForParams/:CustomerID',
    json(),
    AccountExistMiddleware,
    DeleteCustomer,
); // Path: http://localhost:PORT/Store Management/Customer Management/delete/:User_idForParams/:OwnerEmailForParams/:CustomerID
