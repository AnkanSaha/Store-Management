...
import { AddnewEmployee, GetEmployee } from "../../../Function/Account Management/Employee Management"; // Path: Function/Account Management/Employee Management.ts
...
EmployeeRouterManagement.post("/create", json(), async(req, res) => {
  ...
  await AddnewEmployee({User_id:User_id, EmployeeDateOfJoining:EmployeeDateOfJoining, EmployeeEmail:EmployeeEmail,EmployeeMonthlySalary:EmployeeMonthlySalary, EmployeeName:EmployeeName, EmployeePhoneNumber:EmployeePhoneNumber, EmployeeRole:EmployeeRole, res:res}); // Calling the controller function
